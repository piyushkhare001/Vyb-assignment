    ...
    <>
      ...
      <div className="flex items-center sm:p-3 sm:w-[20rem] justify-evenly min-h-screen mt-2 sm:border sm:border-black sm:rounded-lg sm:m-2">
        ...
        <div className="flex flex-col gap-3 ">
          ...
          />
          {passErr && <p className="text-red-600">Password length should be at least 6 characters</p>}
          ...
          <Link href="/Sign-up" className="text-center">{`Don't have an account? Sign Up`}</Link>
        </div>
      </div>
    </>
  );
